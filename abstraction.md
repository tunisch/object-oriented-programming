...
Bir sinif icerisinde o siniftan nesne uretmek istemiyorsak bize mantiksiz geliyorsa nesne uretmek abstraction ile soyutlayarak bu sayede o siniftan nesne uretimini engellemis oluyoruz.

> Siniftan Nesne uretmiyorsak neden Sinifi soyutluyoruz?

- Inheritance da bazi ara siniflarda o siniftan nesne uretmek mantiksiz olabiliyor bu yuzden bu yontemi kullanarak bu durumun onune gecebiliyoruz.
...
<img width="1305" height="1055" alt="image" src="https://github.com/user-attachments/assets/cea0c999-8d91-49ca-a446-31b69efefdac" />

- Yukardaki gorselde, **Akademisyen** Classi ve **Memur** Classi Ara siniflar bu yuzden nesne uretmemize gerek yok zaten Akademisyen bir birey degilde topluluktur, o yuzden bu siniflari **abstract** olarak tanimlayip baska birinin **nesne uretmemesini** saglariz. UML de bu sinif isimlerini *italik* yaparak **abstract oldugunu belirtiriz**.
